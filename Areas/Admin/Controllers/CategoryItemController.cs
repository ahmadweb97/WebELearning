...
namespace WebELearning.Areas.Admin.Controllers
{
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Index(int categoryId)
        {
            List<CategoryItem> list = await (from catItem in _context.CategoryItem
                                             ...
                                             select new CategoryItem
                                             {
                                                 ...
                                                 DateTimeReleaseDate = catItem.DateTimeReleaseDate,
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId,MediaTypeId,DateTimeReleaseDate")] CategoryItem categoryItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId,MediaTypeId,DateTimeReleaseDate")] CategoryItem categoryItem)
        {
